<template>
    <header>
        <div class="flex justify-between items-center p-8 lg:px-12 relative z-20">
            ...
            <!-- Navbar links -->
            <nav
                :class="[`fixed inset-0 z-20 flex flex-col items-center justify-center bg-primary md:relative md:bg-transparent md:flex md:justify-between md:flex-row ${isMenuOpen ? 'block' : 'hidden'}`]">
                ...
                <button @click="toggleDarkMode" class="text-white ml-20 hidden md:block">
                    <!-- Show Moon icon if dark mode is on , otherwise show sun icon -->
