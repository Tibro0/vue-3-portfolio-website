        ...
        <main class="absolute grid lg:grid-cols-2 grid-cols-1 items-center p-2 lg:p-8">
            <header class="text-center lg:text-left">
                <h1 class="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold">
                    Hi, I'm <span
                        class="text-secondary stroke-text text-stroke-primary dark:text-stroke-secondary">Steven</span>
                </h1>
                <p class="text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati reiciendis natus harum
                    accusantium ea dolorum dolore nam error sequi tempore est, odio esse distinctio dicta suscipit
                    eveniet praesentium saepe quae.
                </p>
